...
<body id="corpo">
    <main>
        <div id="titulosFixo">
            ...
            <h2 id="subTitulo">Alugueis Pedentes</h2>
            <h2 id="titulo_print"></h2>

            <div id="tabelaFiltros">
                <form action="filtro_pedentes.php" id="filtro" method="post">
                    <div class="caixa">
            ...
            $sql = "SELECT * FROM alugueis WHERE cod_liv LIKE '%$nomePesq%' AND dt_entrega IS NULL ORDER BY id_aluguel " . $filtroOrdem . ""; // Substitua 'tabela' pelo nome da sua tabela
            ...
            echo "<div class='class' id='qtd'><p>Quantidade de Alugueis Pedentes: <strong>$qtdAlugueis</strong></p></div>";
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    if (empty($row["dt_entrega"])) {
                        ...
                        <tr>
                            ...
                            <td>Não entregue</td> 
                            <td id='col_inf'>
                                    <a href='editEntrega.php?id=".$row['id_aluguel']."'>
                                        <img src='../img/inf.png'>
                                    </a>
                            </td>
                            </tr>";
