<?php
    ...
    if($registro == 0){
        ...
        session_start();
        $_SESSION['nome_autor'] = $autor;

        $sql = "INSERT INTO autores (id, nome) VALUES (null, '$autor')";
           ...
           <main>
            ...
            <div id='div_main'>
                ...
                <h2>Cadastro Feito com Sucesso</h2>
                    <p>Autor(a): <strong>$autor</strong></p>
                    <a href='../tela-cadastro/cadastro_livro.php?autor=$autor'><p id='teste'>Cadastrar Um Livro com esse Autor(a)</p></a>
                    <div id='box-button'>
                    <a href='exclusao/excluir_autor.php' class='button'>
        ...
        //  Buscando dados do livro que será excluido
         $AutorSQL = "SELECT * FROM autores WHERE nome = '$autor'";
         $localizarAutor= mysqli_query($conexao, $AutorSQL) or die (mysql_error());
         $dados = mysqli_fetch_array($localizarAutor);
 
         session_start();
         unset($_SESSION['nome_autor']);
 
         $_SESSION['nome_autor'] = $dados['nome'];
        ...
        <body>
            ...
            <div id='div_main'>
                <h1>Organization Books</h1>
                <h2>Erro</h2>
                <p>Infelizmente já existe um(a) autor(a) cadastrada no nome de <strong>$autor</strong></p>
                <div id='box-button'>
                    <a href='exclusao/excluir_autor.php' class='button'>
                        <img src='../img/icon_delete.png' alt='livro com um 'X' que significa deletar o livro digitado'>
                        <figcaption class='legenda'>Excluir</figcaption>
